  ...
  <div class="container px-5 pb-24 mx-auto">
    <div class="flex flex-wrap -m-4">
      <div class="p-4 xl:w-1/3 md:w-1/2 w-full">
        <div id="plan1" class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
          ...
          <button class="flex items-center mt-auto text-white bg-gray-400 border-0 py-2 px-4 w-full focus:outline-none hover:bg-gray-500 rounded">S'abonner
      ...
      <div class="p-4 xl:w-1/3 md:w-1/2 w-full">
        <div id="plan2"  class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
      ...
      <div class="p-4 xl:w-1/3 md:w-1/2 w-full">
        <div id="plan3"  class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
