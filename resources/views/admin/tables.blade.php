...
<head>
    ...
    <style>
        ...
        .bg-sidebar { background: #132c1a; }
        .cta-btn { color: #132c1a; }
        .upgrade-btn { background: #1947ee; }
        .upgrade-btn:hover { background: #000; }
        .active-nav-link { background: #09170d; }
...
<aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="/tables" class="flex items-center active-nav-link text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
